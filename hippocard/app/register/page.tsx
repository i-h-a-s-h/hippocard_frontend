...
import { FaUserInjured, FaUserMd, FaHospital, FaClinicMedical, FaHeartbeat, FaNotesMedical, FaTablets, 
         FaStethoscope, FaBriefcaseMedical, FaDna, FaLungs, FaBrain, FaVirus, FaAmbulance, FaSyringe, 
         FaHospitalUser, FaBandAid, FaPrescription, FaFlask, FaMicroscope, FaXRay, FaThermometerHalf, 
         FaHeadSideMask, FaHandHoldingMedical } from 'react-icons/fa';
